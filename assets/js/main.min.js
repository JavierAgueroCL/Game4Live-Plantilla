...
window.fbAsyncInit = function() {
	FB.init({
		appId      : "318595321672515", // Set YOUR APP ID
			...
			FB.api('/me', function(response) {
				console.log("Received response is " + response);
				 if(typeof(response.email) =="undefined"){
                                alert("No logramos entrar! Ha ocurrido algun error con tu Facebook");}						
				jQuery.ajax({
					...
					error: function(){
						alert('Algo malo ha pasado.');
					}
				});
			});
		// cancelled
		} else {
			alert( 'No autorizo o cancelo el registro' );
			userpro_end_load( form );
		}
